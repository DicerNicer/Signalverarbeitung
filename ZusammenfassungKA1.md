...
$x(t) = x(−t)$
![Hier sollte ein Bild sein](/DicerNicer/Signalverarbeitung/tree/main/Bilder/gerade.png)

#### ungerade

$x(t) = −x(−t)$
![Hier sollte ein Bild sein](/DicerNicer/Signalverarbeitung/tree/main/Bilder/ungerade.png)
